      ...
      <div>
        ...
        {/* <div className="inset-0 bg-opacity-10 bg-gradient-to-b from-transparent to-black pointer-events-none">
          <div className="flex-col  items-center justify-center">
            <div className="flex text-red-700  justify-center items-center">
              <div className="text-2xl">
                <h1>You are not login , Please SignIn to access the bot</h1>
              </div>
            </div>

            <div className="min-h-screen flex flex-col items-center py-10 px-5 bg-chatbot1">
              <h1 className="text-4xl font-bold text-gray-800 mb-6">
                About Our Project
              </h1>
              <p className="text-center text-lg text-gray-600 max-w-2xl mb-10">
                ...
                <Accordion>
                  ...
                  <AccordionItem key="2" title="🛠 Technologies Used">
                    <ul className="list-disc pl-5 text-gray-700">
                      ...
                      <li>
                        AI & NLP: Advanced techniques for sentiment analysis and
                        emotion prediction.
                      </li>
                    </ul>
                  </AccordionItem>
